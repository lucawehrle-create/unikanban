// Rendert das Intro-Story-Set "Was ist SemBan?" (9:16, 1080x1920) als PNG.
// Eigenständiger Flaggschiff-Pitch (Hook → Problem → Idee → Features → CTA).
//   node marketing/instagram/slides/render-intro.mjs
...
// ----------------------------------------------------------------- Slides
const SLIDES = [
  { file: 'intro-1', theme: 'indigo', hero: true, kicker: 'Lernplaner für Studis',
    title: 'Das ist\nSemBan.',
    sub: 'Der Planer, der den Uni-Rhythmus versteht.',
    note: 'Swipe →' },

  { file: 'intro-2', theme: 'paper', kicker: 'Das Problem',
    title: 'Dein Studium kennt\nkeinen Pausenknopf.',
    sub: 'Übungsblätter jede Woche, Hausarbeiten, Referate, Klausuren — parallel und mit harten Fristen.' },

  { file: 'intro-3', theme: 'paper', kicker: 'Warum Standard-Tools scheitern',
    title: 'Ein Kalender sieht\nTermine. Kein System.',
    sub: 'Notion ist ein leeres Blatt. Trello kennt keine Abgabefristen. Du baust dir alles selbst zusammen.' },

  { file: 'intro-4', theme: 'paper', kicker: 'Die Idee',
    title: 'Ein echtes\nakademisches Modell.',
    flow: ['Semester', 'Kurse · ECTS · Note', 'Aufgaben mit Lebenszyklus'],
    sub: 'Eingebaut — nicht mühsam zusammengebastelt.' },

  { file: 'intro-5', theme: 'paper', kicker: 'Was du bekommst · 1',
    title: 'Alle Fristen,\nein Board.',
    sub: 'Farbcodiert nach Kurs, sortiert nach »Diese Woche«. Überfälliges fällt sofort auf.' },

  { file: 'intro-6', theme: 'paper', kicker: 'Was du bekommst · 2',
    title: 'Aufgaben in\n5 Sekunden.',
    code: true,
    sub: 'Eine Taste, ein Satz — Kurs, Typ und Frist werden automatisch erkannt.' },

  { file: 'intro-7', theme: 'paper', kicker: 'Was du bekommst · 3',
    title: 'Lernplan auf\nKnopfdruck.',
    sub: 'Klausurdatum rein → verteilter Lernplan über mehrere Tage. Schluss mit Last-Minute.' },

  { file: 'intro-8', theme: 'paper', kicker: 'Und das Beste',
    title: 'Kostenlos.\nWerbefrei. Offline.',
    sub: 'Kein Account nötig zum Start. Deine Daten bleiben auf deinem Gerät.' },

  { file: 'intro-9', theme: 'indigo', kicker: 'Bereit?',
    title: 'Sortier das\nChaos.',
    sub: 'Heute noch — in unter einer Minute startklar.',
...
await browser.close()
console.log(`\nFertig: ${SLIDES.length} Intro-Slides → ${OUT}`)
