...
export function TaskEditor({ courses }: { courses: Course[] }) {
  ...
  // Auto-Aufgaben, die der Nutzer hier bearbeitet, als „angefasst" markieren –
  // damit sie beim Neugenerieren der Serie nicht durch Standardwerte ersetzt
  // werden (schützt Titel, Frist, Notizen, Punkte … einer offenen Serien-Aufgabe).
  const patch = (p: Partial<Task>) =>
    void updateTask(id, task.autoGenerated ? { ...p, userEdited: true } : p)
